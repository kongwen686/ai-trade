...
class IndicatorTests(unittest.TestCase):
    ...
    def test_indicator_snapshot_detects_bullish_profile(self) -> None:
        ...
        self.assertLess(snapshot.boll_dn, snapshot.boll_mb)
        self.assertLess(snapshot.boll_mb, snapshot.boll_up)
        self.assertGreater(snapshot.boll_bandwidth_pct, 0)
        self.assertGreater(snapshot.boll_position, 0.5)
        ...
        self.assertIn(snapshot.volatility_regime, {"compressed", "normal", "expansion", "extreme"})
        self.assertGreaterEqual(snapshot.volatility_percentile, 0)
        self.assertGreaterEqual(snapshot.atr_pct, 0)
