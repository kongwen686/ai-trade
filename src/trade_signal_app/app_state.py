...
class AppState:
    ...
    def _build_scanner(self, config: RuntimeConfig) -> SignalScanner:
        effective_settings = replace(
            ...
            btc_min_quote_volume=config.scan_defaults.btc_min_quote_volume,
            btc_min_trade_count=config.scan_defaults.btc_min_trade_count,
            eth_min_quote_volume=config.scan_defaults.eth_min_quote_volume,
            eth_min_trade_count=config.scan_defaults.eth_min_trade_count,
            xrp_min_quote_volume=config.scan_defaults.xrp_min_quote_volume,
            xrp_min_trade_count=config.scan_defaults.xrp_min_trade_count,
            sol_min_quote_volume=config.scan_defaults.sol_min_quote_volume,
            sol_min_trade_count=config.scan_defaults.sol_min_trade_count,
            bnb_min_quote_volume=config.scan_defaults.bnb_min_quote_volume,
            bnb_min_trade_count=config.scan_defaults.bnb_min_trade_count,
            top30_min_quote_volume=config.scan_defaults.top30_min_quote_volume,
            top30_min_trade_count=config.scan_defaults.top30_min_trade_count,
        ...
        community_provider = build_community_provider(
            ...
            x_provider=effective_settings.x_provider,
