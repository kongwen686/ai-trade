...
def _terminal_cache_key(runtime_config: RuntimeConfig) -> tuple[object, ...]:
    ...
    return (
        ...
        scan.btc_min_quote_volume,
        scan.btc_min_trade_count,
        scan.eth_min_quote_volume,
        scan.eth_min_trade_count,
        scan.xrp_min_quote_volume,
        scan.xrp_min_trade_count,
        scan.sol_min_quote_volume,
        scan.sol_min_trade_count,
        scan.bnb_min_quote_volume,
        scan.bnb_min_trade_count,
        scan.top30_min_quote_volume,
        scan.top30_min_trade_count,
        scan.dynamic_activity_enabled,
        scan.activity_discovery_pool,
        scan.activity_baseline_hours,
        scan.activity_surge_ratio,
        scan.activity_trade_surge_ratio,
        scan.activity_contraction_ratio,
        scan.activity_trade_contraction_ratio,
        scan.activity_min_consecutive_windows,
        scan.activity_liquidity_floor_ratio,
        scan.activity_normalized_threshold_ratio,
...
def _default_scan_params(runtime_config: RuntimeConfig) -> dict[str, object]:
    ...
    return {
        ...
        "btc_min_quote_volume": scan_defaults.btc_min_quote_volume,
        "btc_min_trade_count": scan_defaults.btc_min_trade_count,
        "eth_min_quote_volume": scan_defaults.eth_min_quote_volume,
        "eth_min_trade_count": scan_defaults.eth_min_trade_count,
        "xrp_min_quote_volume": scan_defaults.xrp_min_quote_volume,
        "xrp_min_trade_count": scan_defaults.xrp_min_trade_count,
        "sol_min_quote_volume": scan_defaults.sol_min_quote_volume,
        "sol_min_trade_count": scan_defaults.sol_min_trade_count,
        "bnb_min_quote_volume": scan_defaults.bnb_min_quote_volume,
        "bnb_min_trade_count": scan_defaults.bnb_min_trade_count,
        "top30_min_quote_volume": scan_defaults.top30_min_quote_volume,
        "top30_min_trade_count": scan_defaults.top30_min_trade_count,
        "dynamic_activity_enabled": scan_defaults.dynamic_activity_enabled,
        "activity_discovery_pool": scan_defaults.activity_discovery_pool,
        "activity_baseline_hours": scan_defaults.activity_baseline_hours,
        "activity_surge_ratio": scan_defaults.activity_surge_ratio,
        "activity_trade_surge_ratio": scan_defaults.activity_trade_surge_ratio,
        "activity_contraction_ratio": scan_defaults.activity_contraction_ratio,
        "activity_trade_contraction_ratio": scan_defaults.activity_trade_contraction_ratio,
        "activity_min_consecutive_windows": scan_defaults.activity_min_consecutive_windows,
        "activity_liquidity_floor_ratio": scan_defaults.activity_liquidity_floor_ratio,
        "activity_normalized_threshold_ratio": scan_defaults.activity_normalized_threshold_ratio,
        "view_mode": "table",
        ...
        try:
            ...
            if parsed.path == "/":
                ...
                html = render_index_page(
                    ...
                    params=params,
                    intervals=["15m", "1h", "2h", "4h", "8h", "12h", "1d"],
                    lang=lang,
