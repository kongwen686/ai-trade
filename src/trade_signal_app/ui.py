...
def format_signal_row(signal: TradeSignal) -> dict:
    ...
    return {
        ...
        "support_distance_pct": signal.indicators.support_distance_pct,
        "resistance_distance_pct": signal.indicators.resistance_distance_pct,
        "support_strength": signal.indicators.support_strength,
        "resistance_strength": signal.indicators.resistance_strength,
        "structure_risk_reward": signal.indicators.structure_risk_reward,
        "pullback_from_high_pct": signal.indicators.pullback_from_high_pct,
        "volatility_regime": signal.indicators.volatility_regime,
        "volatility_label": signal.indicators.volatility_label,
        "realized_volatility_pct": signal.indicators.realized_volatility_pct,
        "baseline_volatility_pct": signal.indicators.baseline_volatility_pct,
        "volatility_percentile": signal.indicators.volatility_percentile,
        "volatility_ratio": signal.indicators.volatility_ratio,
        "atr_pct": signal.indicators.atr_pct,
        "volatility_shock_sigma": signal.indicators.volatility_shock_sigma,
        ...
        "community_confidence": None if signal.community_signal is None else signal.community_signal.confidence,
        "community_risk_score": None if signal.community_signal is None else signal.community_signal.risk_score,
        "community_freshness_minutes": None if signal.community_signal is None else signal.community_signal.freshness_minutes,
        "community_source_count": None if signal.community_signal is None else signal.community_signal.source_count,
