...
_VALUE_LABELS = {
    "zh": {
        ...
        "paper_closed": "模拟平仓",
        "risk_blocked": "风控阻断",
        "no_eligible_signal": "未满足交易条件",
        "test_accepted": "测试通过",
        "filled": "已成交",
        "rejected": "已拒绝",
        "balance_locked": "余额已锁定",
        "external_closed": "外部已处理",
        "skipped": "已跳过",
        "BUY": "买入",
        "SELL": "卖出",
        "SYNC": "对账",
        ...
        "basis_converged": "基差收敛",
        "basis_stop": "基差止损",
        "funding_reversal": "资金费率反转",
        "max_holding": "达到最长持有期",
        "mean_reversion": "均值回归",
        "z_stop": "Z 分数止损",
        "long_spread": "做多价差",
    ...
    "en": {
        ...
        "no_eligible_signal": "No Eligible Signal",
        "test_accepted": "Test Accepted",
        "filled": "Filled",
        "rejected": "Rejected",
        "balance_locked": "Balance Locked",
        "external_closed": "Handled Externally",
        "skipped": "Skipped",
        "BUY": "Buy",
        "SELL": "Sell",
        "SYNC": "Reconcile",
        ...
        "wait_score": "Wait Score",
        "wait_pullback": "Wait Pullback",
        "wait_support": "Wait Support",
        "wait_volatility": "Wait Volatility",
        "wait_volume": "Wait Volume",
        "wait_buy_pressure": "Wait Buy Pressure",
        "wait_trend": "Wait Trend Confluence",
        "wait_momentum": "Wait Momentum Confluence",
        "entry_ready": "Confluence Ready",
        "watch": "Watch",
...
BACKTEST_PRESET_ZH_LABELS = {
    ...
    "trend_pullback_conservative": "保守趋势回踩",
    "breakout_confirmed": "确认突破",
    "mean_reversion_guarded": "受控均值回归",
    "quality_rotation": "高质量轮动",
