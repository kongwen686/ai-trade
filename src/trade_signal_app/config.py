...
class AppSettings:
    ...
    btc_min_quote_volume: float = float(os.getenv("BTC_MIN_QUOTE_VOLUME", "100000000"))
    btc_min_trade_count: int = int(os.getenv("BTC_MIN_TRADE_COUNT", "50000"))
    eth_min_quote_volume: float = float(os.getenv("ETH_MIN_QUOTE_VOLUME", "80000000"))
    eth_min_trade_count: int = int(os.getenv("ETH_MIN_TRADE_COUNT", "40000"))
    xrp_min_quote_volume: float = float(os.getenv("XRP_MIN_QUOTE_VOLUME", "30000000"))
    xrp_min_trade_count: int = int(os.getenv("XRP_MIN_TRADE_COUNT", "15000"))
    sol_min_quote_volume: float = float(os.getenv("SOL_MIN_QUOTE_VOLUME", "50000000"))
    sol_min_trade_count: int = int(os.getenv("SOL_MIN_TRADE_COUNT", "25000"))
    bnb_min_quote_volume: float = float(os.getenv("BNB_MIN_QUOTE_VOLUME", "30000000"))
    bnb_min_trade_count: int = int(os.getenv("BNB_MIN_TRADE_COUNT", "15000"))
    top30_min_quote_volume: float = float(os.getenv("TOP30_MIN_QUOTE_VOLUME", "15000000"))
    top30_min_trade_count: int = int(os.getenv("TOP30_MIN_TRADE_COUNT", "5000"))
